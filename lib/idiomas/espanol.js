...
//main.js
const smsWelcome = () => { return `*╭┈🤖 Bienvenido(a) al Grupo @subject 🤖┈✦*\n*┊ 💖 @user, gracias por unirte!*\n*┊✨ Gracias por utilizar a ${wm} en tus grupos. ✨*\n*╰┈ 📝 Por favor, revisa la descripción del grupo. *\n\n${String.fromCharCode(8206).repeat(850)}\n@desc`}
const smsBye = () => { return 'NOS CUESTA ENTENDER COMO HAY GENTE QUÉ NO ENTIENDE LA FUCKING VIBRA 🙄 Y NUCA LA ENTENDERÁ. BYE!! 😎'}
